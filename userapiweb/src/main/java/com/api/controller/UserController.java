...
public class UserController {
	...
	public @ResponseBody User updateUser(@RequestBody User newUser) {
		User user = userDAO.listByIDWithPassword(newUser.getUser_id());
		...
		user.setPassword((newUser.getPassword() == null || newUser.getPassword().isEmpty()) ? user.getPassword() : newUser.getPassword());
		userDAO.update(user);
